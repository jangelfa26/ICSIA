...
function App() {
  ...
  function agregarErrorNuevo() {
    const errorNuevo = {
      id: crypto.randomUUID(),
      mensaje: "Error " + Math.floor(Math.random() * 500 + 100) + " del servidor"
    }
    cambiarListaErrores([...listaErrores, errorNuevo])
  }
  ...
  function borrarUnError(idDelError) {
    const nuevaLista = listaErrores.filter(error => error.id !== idDelError)
    cambiarListaErrores(nuevaLista)
  }
